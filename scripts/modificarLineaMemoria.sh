...
archivos=("../testsFinal/memoria_configs/base.config" "../testsFinal/memoria_configs/memoria.config" "../testsFinal/memoria_configs/deadlock.config" "../testsFinal/memoria_configs/filesystem.config" "../testsFinal/memoria_configs/error.config")  # Lista de archivos
