...
archivos=("../testsFinal/cpu_configs/base.config" "../testsFinal/cpu_configs/memoria.config" "../testsFinal/cpu_configs/deadlock.config" "../testsFinal/cpu_configs/filesystem.config" "../testsFinal/cpu_configs/error.config")  # Lista de archivos
