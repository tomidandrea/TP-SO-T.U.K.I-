...
archivos=("../testsFinal/filesystem_configs/base.config" "../testsFinal/filesystem_configs/memoria.config" "../testsFinal/filesystem_configs/deadlock.config" "../testsFinal/filesystem_configs/filesystem.config" "../testsFinal/filesystem_configs/error.config")  # Lista de archivos
